...
namespace VideoCallP2P
{
    ...
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(StartVideoCapture).Name);
        ...
        public void GrabImg()
        {
            ...
            sampGrabber.SetCallback(new SampleGrabberCallback(), 1);
        }
