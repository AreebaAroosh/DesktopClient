...
namespace VideoCallP2P.Recorder.DirectShowNET
{
    ...
    [ComImport, Guid("6B652FFF-11FE-4fce-92AD-0266B5D7C78F"), ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    ...
    [ComImport, Guid("0579154A-2B53-4994-B0D0-E773148EFF85"), ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
